...
__all__ = ['tiny_resnet18', 'tiny_resnet34']
...
class ResNet(nn.Module):
    ...
    def extract(self, x):
        ...
        x = self.layer3(x)              # B x 32 x 16 x 16
        return x         



def tiny_resnet18(pretrained=False, path=None, **kwargs):
    """
...
def tiny_resnet34(pretrained=False, path=None, **kwargs):
    """
...
def tiny_resnet50(pretrained=False, path=None, **kwargs):
    """
...
if __name__ == '__main__':
    ...
    model = tiny_resnet34(num_classes=200)
    out1, out2, out3 = model(x, x, x)
